...
# Ralph Frontend Loop - Droid Implementation
# Usage:
...
LOOP_NAME="frontend"
STATE_FILE="$SCRIPT_DIR/../web-ui/state/frontend-state.json"
...
**Source Location:** $PROJECT_ROOT/src/frontend/
...
cleanup() {
    echo ""
    echo "Shutting down frontend loop..."
...
# Initialize state
update_state "starting" "Initializing frontend loop"
...
echo ""
echo "Frontend loop finished after $ITERATION iterations"
